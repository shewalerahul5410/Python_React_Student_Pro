    ...
    * Default `.create()` and `.update()` implementations are provided.
    ...
    def get_fields(self):
        ...
        for field_name in declared_fields.keys():
            if (
                field_name in info.relations
                and info.relations[field_name].to_many
                and declared_fields[field_name].default is None
            ):
                raise ValueError(
    ...
    def _get_constraint_violation_error_message(self, constraint):
        ...
        default_error_message = constraint.default_violation_error_message % {
